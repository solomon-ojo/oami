        ...
        <div className="pb-12 md:pb-20">
          ...
          <div className="bg-blue-600 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl" data-aos="zoom-y-out">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center">
              ...
              {/* CTA button */}
              <div>
                <a className="btn text-blue-600 bg-gradient-to-r from-blue-100 to-white" href="https://www.paypal.com/ncp/payment/MR8A9R34JRTQL"  target='_blank'>Partner with us</a>
              </div>
