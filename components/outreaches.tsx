...
import FeaturesImage from '@/public/images/outreaches-01.jpg'
...
export default function Outreaches() {
  ...
  return (
    <section className="relative">
      ...
      <div className="absolute inset-0 bg-slate-100 pointer-events-none mb- md:mb-80" aria-hidden="true"></div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12">
            <h2 className="h2 font-playfair-display text-slate-800 mb-4">Our Outreaches</h2>
