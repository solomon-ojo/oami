      ...
      <div ref={mobileNav}>
        ...
        >
          <ul className="px-5 py-2">
            ...
            <li>
              <Link href="https://www.paypal.com/ncp/payment/MR8A9R34JRTQL" locale={false} target='_blank' className="btn-sm text-gray-200 bg-gray-900 hover:bg-gray-800 w-full my-2" onClick={() => setMobileNavOpen(false)}>
                <span>Give</span>
